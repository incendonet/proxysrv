...
StringParam & StringParam::operator=(
  const StringParam & param
)
{
...
{
  m_StartsInNewLine = param.Left( 2 ) == "\r\n" ;
  m_EndsWithNewLine = param.Right( 2 ) == "\r\n" ;
  m_Value = param.Trim();
  return *this;
}

void StringParam::PrintOn( 
  ostream & strm 
)const
{
...
StringParam::operator PString()const
{
  return AsString();
}

PObject * StringParam::Clone()const
{
