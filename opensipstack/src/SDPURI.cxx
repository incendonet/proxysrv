...
)
{
  m_Name = "u";
  m_URI = uri;
  m_Value = uri.AsString();
}

SDPURI & SDPURI::operator=( const PString & header )
{
...
SDPURI & SDPURI::operator=( const SDPURI & header )
{
  SDPHeader::operator =( header );
  m_URI = header.m_URI;
  return *this;
...
SDPURI & SDPURI::operator=( const PURL & uri )
{
  m_URI = uri;
  m_Value = uri.AsString();
  m_Name = "u";
...
PObject * SDPURI::Clone()const
{
  return new SDPURI( *this );
}
