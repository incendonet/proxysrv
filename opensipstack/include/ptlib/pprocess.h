 ...
 *
 * $Log: pprocess.h,v $
 * Revision 1.4  2007/01/10 10:08:33  rcolobong
 * added build number setters
 *
 * Revision 1.3  2007/01/09 12:16:42  joegenbaclor
 * Added version setters
 *
 * Revision 1.2  2006/12/22 07:39:06  joegenbaclor
 * More on command line argument parsing.
 *
 * Revision 1.1  2006/08/04 03:33:25  joegenbaclor
 * Moved pwlib and OPAL headers to root include directory
 *
 * Revision 1.1  2006/06/29 04:17:21  joegenbaclor
 * *** empty log message ***
 *
...
class PProcess : public PThread
{
  ...
  //@}
    ...
    */
    ...
    PINLINE void SetProductName( const PString & name ){ productName =   name; };
    PINLINE void SetMajorVersion( WORD v ){ majorVersion = v; };
    PINLINE void SetMinorVersion( WORD v ){ minorVersion = v; };
    PINLINE void SetBuildNumber( WORD v ) { buildNumber = v; };
