...
#ifndef SDPSESSIONAME_H
#define SDPSESSIONAME_H

#include "SDPHeader.h"

namespace SDP
{
  class SDPSessionName : public SDPHeader
  {
    PCLASSINFO( SDPSessionName, SDPHeader );
  public:
