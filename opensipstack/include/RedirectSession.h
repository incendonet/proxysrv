...
#ifndef REDIRECTSESSION_H
#define REDIRECTSESSION_H
...
namespace UACORE
{
  class RedirectSessionManager;

  class RedirectSession : public SIPSession
  {
    PCLASSINFO( RedirectSession, SIPSession );
  public:
