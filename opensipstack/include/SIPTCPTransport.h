...
#ifndef SIPTCPTRANSPORT_H
#define SIPTCPTRANSPORT_H
...
namespace SIPTransports
{
  ...
  class SIPTCPTransport : public SIPTransport
  {
    PCLASSINFO( SIPTCPTransport, SIPTransport );
  public:
