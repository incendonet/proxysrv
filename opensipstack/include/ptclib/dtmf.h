 ...
 *
 * $Log: dtmf.h,v $
 * Revision 1.2  2006/12/12 23:53:41  joegenbaclor
 ...
 *
 * Revision 1.1  2006/06/29 04:17:13  joegenbaclor
 * *** empty log message ***
 *
...
class PDTMFEncoder : public PBYTEArray
{
  ...
  public:
    ...
    /**
      * Generate PCM data for a single cadence of the UK standard ring tone
    ...
    /**
      * Generate PCM data for 1 second of UK standard dial tone 
      * of 350/440hz 
      */
    void GenerateDialTone()
    {
      AddTone(350, 440, 10000);
    }

    /**
      * Generate PCM data for a single cadence of the UK standard busy tone
