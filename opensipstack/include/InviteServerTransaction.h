 ...
 *
 * $Log: InviteServerTransaction.h,v $
...
#ifndef INVITESERVERTRANSACTION_H
#define INVITESERVERTRANSACTION_H
...
namespace SIPFSM
{
  ...
  class InviteServerTransaction : public SIPTransaction
  {
    PCLASSINFO( InviteServerTransaction, PObject );
  public:
    ...
    virtual ~InviteServerTransaction();
    ...
    virtual void HandleStateConfirmed(
      SIPMessage & message,
      BOOL isSendEvent
    );
