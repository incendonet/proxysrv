 ...
 *
 * $Log: rtp.h,v $
 * Revision 1.3  2006/09/21 04:53:28  joegenbaclor
 * Corrected typos from last commit
 *
 * Revision 1.2  2006/09/21 04:29:28  joegenbaclor
 * Added XORHash accessors
 *
 * Revision 1.1  2006/08/04 07:47:19  joegenbaclor
 * *** empty log message ***
 *
 * Revision 1.2  2006/07/06 05:38:12  joegenbaclor
 * Final last minute changes to CBCOM hash support
 *
 * Revision 1.1  2006/06/26 03:02:31  joegenbaclor
...
class RTP_UDP : public RTP_Session
{
  ...
  //@}
    ...
    PINLINE BOOL IsXORHashEnabled()const{ return xorHash; };
    PINLINE void SetXORHash( BOOL hash = TRUE ){ xorHash = hash; };
