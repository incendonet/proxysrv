...
namespace SIPParser
{
  class StringParam : public PObject
  {
    PCLASSINFO( StringParam, PObject );
  public:
    ...
    PINLINE const PString & AsString()const{ return m_Value; };
